...
const [testVariable, setTestVar] = useState("About me_1");
  ...
  return (
    ...
    <Center>
      ...
      <Text className={styles.projname}><strong>TRAILER</strong></Text>
      <Group justify="space-between" className={styles.info} grow gap="xs">
        ...
        <div>
          ...
          <Text className={styles.textblue}>
            Semester project Interactive Media Motion Graphics at the Augsburg University of Applied Sciences. The task was to animate a Trailer. ...
          </Text>
        </div>
      </Group>
